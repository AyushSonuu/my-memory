...
```mermaid
graph LR
    M2(("Module 2<br/>IR & Search"))
    M2 --> ARCH["Retriever Architecture"]
    M2 --> KW["Keyword Search<br/>TF-IDF / BM25"]
    M2 --> SEM["Semantic Search<br/>Embeddings"]
    M2 --> HYB["Hybrid Search"]
    M2 --> EVAL["Retrieval Evaluation"]
...
| 08 | Hybrid Search | Combining keyword + semantic + metadata with RRF |
| 09 | Vector Embeddings | Using embeddings in RAG pipelines |
