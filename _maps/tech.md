...
|-------|--------|---------|-------------|
| [🤖 Agentic AI](../tech/agentic-ai/README.md) | 🔴 M1-M2 ✅, M3-M5 pending | 13/30 | Task Decomposition, Evals, 4 Design Patterns, Reflection (basic + multimodal + external feedback), Eval types (objective, rubric, error analysis) |
