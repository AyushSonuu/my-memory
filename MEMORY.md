...
- **Progress:** M1: 7/10, M2: 8/12, M3: 2/11, M4-M5: not started (18/62 total)
- **M2 Progress:** Metadata filtering, TF-IDF, BM25, embedding model training, hybrid search, **retrieval evaluation metrics** ✅
- **M3 Progress:** Module intro ✅, **vector databases** ✅
- **Key concepts so far:** RAG architecture, retriever + LLM + KB, applications, LLM foundations, IR basics, keyword vs semantic search, RRF + beta tuning, Precision/Recall/@K, MAP, MRR, Weaviate, alpha parameter
