...
| **`index.html`** (root) | **REMOVED** — now using MkDocs Material. Run `mkdocs build` to regenerate `docs/` folder. |
| **`docs/` folder** | Auto-generated by MkDocs. Deploy via GitHub Pages (Settings → Pages → Source: main, folder: /docs). To rebuild: `export PATH="/Users/I772464/Library/Python/3.9/bin:$PATH" && mkdocs build` |
