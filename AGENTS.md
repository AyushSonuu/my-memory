...
| **`docs/` folder** | Auto-generated by MkDocs. Deploy via GitHub Pages (Settings → Pages → Source: main, folder: /docs). To rebuild: `.venv/bin/mkdocs build` (venv has mkdocs-material + mkdocs-jupyter) |
